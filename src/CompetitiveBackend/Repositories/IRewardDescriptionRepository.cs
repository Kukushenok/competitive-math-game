...
namespace CompetitiveBackend.Repositories
{
    public interface IRewardDescriptionRepository
    {
        ...
        /// <exception cref="Core.Exceptions.Repository.IncorrectOperationException">Описание уже есть</exception>
        ...
        /// <exception cref="Core.Exceptions.Repository.IncorrectOperationException">Описания награды с таким ID не существует</exception>
        ...
        /// <exception cref="Core.Exceptions.Repository.MissingDataException">Описания награды с таким ID не существует</exception>

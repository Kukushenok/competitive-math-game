...
namespace CompetitiveBackend.Controllers
{
    ...
    {
        private readonly ICompetitionRewardEditUseCase editRewards;
        private readonly ICompetitionWatchUseCase watchRewards;
        ...
        {
            return await watchRewards.GetRewardsFor(compID);
        }
        ...
        {
            var creating = new CreateCompetitionRewardDTO(null, rewardDTO.RewardDescriptionID, compID, rewardDTO.ConditionByRank, rewardDTO.ConditionByPlace);
            using ICompetitionRewardEditUseCase self = await editRewards.Auth(HttpContext);
        ...
        /// <param name="compID">Идентификатор соревнования.</param>
        /// <param name="rewardID">Идентификатор выдаваемой награды.</param>
        /// <param name="rewardDTO">Награда.</param>
        ...
        {
            var dto = new UpdateCompetitionRewardDTO(rewardID, rewardDTO.RewardDescriptionID, rewardDTO.ConditionByRank, rewardDTO.ConditionByPlace);
            using ICompetitionRewardEditUseCase self = await editRewards.Auth(HttpContext);

...
namespace RepositoriesRealisation
{
    ...
    {
        public bool SetUpRewardGranter { get; private set; }
        public bool SetUpConnectionStringGetter { get; private set; }
        ...
        {
            SetUpConnectionStringGetter = true;
            coll.AddScoped(p => new PrivilegyConnectionStringGetter(
